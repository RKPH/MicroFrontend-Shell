    ...
    return (
        <header className="w-full h-[121px] bg-black relative">
            <div className="w-full h-10 bg-black flex items-center justify-center tracking-[1.2px]">
                <button
                    className="h-full text-[11px] font-[AdihausDIN] uppercase font-bold text-white px-10 hover:opacity-50 hover:bg-gray-800">
                    Easy return{" "}
                    <span>
            <ExpandMoreIcon/>{" "}
          </span>
                ...
                <nav className="grid grid-cols-4 items-center w-full px-4">
                    ...
                    <div className="flex items-center justify-end space-x-4 col-span-1">
                        ...
                        <div className="relative">
                            ...
                            <span
                                className="absolute top-0 left-1/2 transform -translate-x-1/2 h-4 w-4 rounded-full bg-yellow-400 text-xs flex items-center justify-center"
                            >
                              {count}
                            </span>
                        </div>
